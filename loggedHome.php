    ...
    <div class="container-fluid p-0 mb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img/res2.png" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(0, 0, 0, .4);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8" style="border:none;">
                                ...
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">GUARANTEED PLUMBING REPAIRS AND INSTALLATIONS FOR:

								<ul style="color:white; font-size:27px;">
                                ...
                                <a href="booking.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">BOOK A SERVICE</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row g-0">
            <div class="col-lg-3 d-none d-lg-flex">
                <div class="d-flex align-items-center justify-content-center bg-primary w-100 h-100">
                    <h1 class="display-3 text-white m-0" style="transform: rotate(-90deg);">7 Years Experience</h1>
                </div>
            </div>
                ...
                <div class="ms-lg-5 ps-lg-5">
                    ...
                    <div class="owl-carousel service-carousel position-relative wow fadeInUp" data-wow-delay="0.1s">
                        <div class="bg-light p-4">
                            <h4 class="mb-3">Clogged Drains <br/> Repairs</h4>
                            <p> <img  src="img/drain_repair.jfif" alt="" style="width:100%; height:300px;"></p>
                        </div>
                        <div class="bg-light p-4">
                            <h4 class="mb-3">Toilet Pipes <br/> Repairs</h4>
                            <p> <img src="img/toilet.jpg" alt="" style="width:100%; height:300px;"></p>
                        </div>
                        <div class="bg-light p-4">
                            <h4 class="mb-3">Sewer Line <br/> Repairs</h4>
                            <p> <img src="img/sewer_pipes_repairs.jfif" alt="" style="width:100%; height:300px;"></p>
                        </div>
                        <div class="bg-light p-4">
                            <h4 class="mb-3">Water Heater <br/> Repairs</h4>
                            <p> <img  src="img/waterheat.jfif" alt="" style="width:100%; height:300px;"></p>
                        </div>
                        <div class="bg-light p-4">
                            <h4 class="mb-3">Leaky Faucets & Pipes Repairs</h4>
                            <p> <img  src="img/leak_pipes.jpg" alt="" style="width:100%; height:300px;"></p>
                        </div>
                        <div class="bg-light p-4">
                            <h4 class="mb-3">Low Water Pressure Repairs</h4>
                            <p> <img  src="img/Water-Pressure-Low.jpg" alt="" style="width:100%; height:300px;"></p>
                        </div>
                    </div>
                </div>
            </div>
