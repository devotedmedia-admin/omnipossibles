                ...
                <div class="navbar-nav me-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-up m-0">
                            ...
                            <a href="" class="dropdown-item">GET QUOTE</a>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="bg-light text-center p-5">
                        <h1 class="mb-4">Select A Service For A Quote</h1>
                        <form method="POST">
                            <div class="row g-3">
                                <div class="col-12">
                                ...
                                ?>
                                <div class="col-12">
                                    <button name="quote" class="btn btn-primary w-100 py-3" type="submit">Get Quote</button>
                                </div>
                            </div>
                        </form>
                    </div>
