        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white p-3 py-lg-0 px-lg-4">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="mt-4 mt-lg-0 me-lg-n4 py-3 px-4 bg-primary d-flex align-items-center">
                    <div class="ms-3">
                        <a href="login.php" class="nav-item nav-link text-white"> Login / Register</a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-4">Since 2015 We Have Been A Trusted Plumbing Company </h1>
                    <p class="mb-4">
					OMNIPOSSIBLES Plumbing has been in business for over 7 years. Our team receives regular training on every kind of plumbing
                    problem common to homes, offices, stores and factories. When you call OMNIPOSSIBLES SOLUTIONS you can be assured of getting a
                    plumber that knows its work best. <br> We offer:
					</p>
                    <p class="fw-medium text-primary"><i class="fa fa-check text-success me-3"></i>Residential plumbing</p>
					                    <p class="fw-medium text-primary"><i class="fa fa-check text-success me-3"></i>Commercial plumbing</p>

                    <p class="fw-medium text-primary"><i class="fa fa-check text-success me-3"></i>Quality services at affordable prices</p>

                 <p class="mb-4">
				 You can trust the OMNIPOSSIBLES Plumbing team to provide you with superior plumbers, excellent workmanship, and courteous service.  Whether you need plumbing repairs or would like to schedule a plumbing inspection for your home or want to maintain your homes plumbing , a plumber from OMNIPOSSIBLES is always ready to help.
				 </p>
                </div>
                <div class="col-lg-6 pt-4" style="min-height: 500px;">
                    <div class="position-relative h-100 wow fadeInUp" data-wow-delay="0.5s">
                        <img class="position-absolute img-fluid w-100 h-100" src="img/plumber.jpg   " style="object-fit: cover; padding: 0 0 50px 100px;" alt="">
                    </div>
                </div>
            </div>
        </div>
